...
export const services = [
  {
    ...
    details : <div><h3>Web Development</h3><p className ="service-paragraph"><h5><strong>Website (Static & Responsive):</strong></h5> We design and develop modern and userfriendly websites that leave a lasting impression. Whether you need a static website for showcasing your business or a responsive website that adapts to different devices, we've got you covered</p>
                    <p className ="service-paragraph"><h5><strong>Blogs:</strong></h5> Our talented writers craft compelling blog content that resonates with your audience. We create informative, engaging, and SEO-friendly blogs that drive traffic to your website and establish you as a thought leader in your industry</p>
                    ...
                    </div>},
  {
    ...
    details : <div><h3>Digital Marketing</h3><p className ="service-paragraph">Digital Marketing is the process of using online channels to promote your products or services. At Creative Digital Media, we use a variety of digital marketing techniques to help our clients reach their target audience and achieve their marketing goals. Our team of experienced digital marketers can help you to develop a custom digital marketing strategy that meets your specific needs</p>
        <p className ="service-paragraph"><h5><strong>Search Engine Optimization (SEO):</strong></h5> Optimizing websites to improve their visibility and organic rankings in search engine results.</p>
        <p className ="service-paragraph"><h5><strong>Email Marketing:</strong></h5> Designing and implementing email campaigns to reach and nurture leads or engage existing customers.</p>
        <p className ="service-paragraph"><h5><strong>Content Marketing:</strong></h5>Creating and distributing valuable, relevant, and engaging content to attract and retain customers.</p>
        ...
        </div>},
  {
    ...
    <p className ="service-paragraph"><h5><strong>Facebook & Instagram</strong></h5> Reels, Stories, Posts, audience engagement, Brand Promotions</p>
    <p className ="service-paragraph"><h5><strong>LinkedIn, Twitter </strong></h5> Connections and Followers engagement through insightful blogs, videos, and photos</p>
...
<div style={{ display: 'flex', justifyContent: 'left' ,alignItems:'left'}}>
...
)},
  {
   ...
   <img src={video1} alt="Video"  className="image"  />
<img src={video2} alt="Video" className="image"  />
