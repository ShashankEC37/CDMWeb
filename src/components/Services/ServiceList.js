...
export const services = [
                    ...
                    </div>},
  {
    ...
    details : <div><h3>Digital Marketing</h3><p className ="service-paragraph">Digital Marketing is the process of using online channels to promote your products or services. At Creative Digital Media, we use a variety of digital marketing techniques to help our clients reach their target audience and achieve their marketing goals. Our team of experienced digital marketers can help you to develop a custom digital marketing strategy that meets your specific needs</p>
  ...
  ,
  {
   ...
   <p className ="service-paragraph"><strong> Efficiency: </strong>3D models can be used to create prototypes and test designs, which can save time and money in the development process. This can help you to bring your products to market faster and more efficiently</p>
   <p className ="service-paragraph"><strong> Creativity:</strong> 3D modeling allows designers to create objects that would be impossible or difficult to create in the real world. This can help you to create unique and eye-catching content for your website that will stand out from the competition.</p>
</div>
)},
  {
    title: 'Videography and Photography',
    image: Videography,
    details :(<div><h3>Videography and Photography</h3><p className ="service-paragraph"><strong>Product Photoshoots:</strong> Our professional photographers skillfully capture your products in the best light, creating visually appealing images that enhance their appeal and entice potential customers.</p>
    <p className ="service-paragraph"><strong>2D Animated Videos:</strong> Engage your audience with captivating 2D animated videos. We leverage the power of animation to tell your brand's story, explain complex concepts, and deliver your message in an engaging and memorable way</p>
   <p className ="service-paragraph"><strong>Video Creation:</strong> From promotional videos to explainer videos, our video creation services help you effectively communicate your message. Our team handles the entire video production process, delivering high-quality videos that resonate with your target audience</p>
 </div>),
